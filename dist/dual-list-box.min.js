...
!function(t){function e(e,n){var o=!1
    if(e.text.indexOf(":")>-1){var i=e.text.split(":")
        ...
        o?i.forEach(function(t){a+=s[t]+" "}):a=s[e.text],console.log(e.value),console.log(s[e.value]),t("<option>",{value:s[e.value],text:a,selected:n.some(function(t){return t[e.value]===s[e.value]})===!0}).appendTo(e.element)}),l(e)})}function n(e){var n=t(e.parentElement+" .unselected"),l=t(e.parentElement+" .selected")
